...
import { CopyCheckIcon, CopyIcon, Globe2Icon, ImagePlusIcon, LockIcon, MoreVerticalIcon, RotateCcwIcon, SparklesIcon, TrashIcon, Loader2Icon } from "lucide-react";
...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
    ...
    const remove = trpc.videos.removed.useMutation({
        onSuccess: () => {
            utils.studio.getMany.invalidate();
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea
                                                ...
                                                placeholder="Add a descripiton to your video"
                                            />
                                        </FormControl>
                                    </FormItem>
                                )}
